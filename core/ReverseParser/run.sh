...
python3 reverse_parser.py -c e950938f171b3cd6367e7e6d7b1d252e6f0e8c9b -g https://github.com/apache/commons-jcs.git -t target -f src/test/org/apache/jcs/access/TestCacheAccess.java
# result = afterCID.txt
